...
char tocniPrvi[4]={'a', 'c', 'c', 'b'};
char tocniVtori[4]={'a', 'c', 'b', 'c'};
char tocniTreti[4][2]={{'a','c'},{'a','d'},{'c','d'},{'b','e'}};
...
int main(){
    ...
    int brojach = 1;
        ...
        cout << "Ocenkata na studentot " << lice.ime << " " << lice.prezime << " e: " << score(poeni) << endl;

        // Dodavanje na informaciite za studentot vo log datotekata
        time_t kviz;
        studenti.open("Students.log", ios::app);
        studenti << "Broj Time-Stamp    Ime        Prezime     Indeks\n" << ++brojach << ". " << asctime(localtime(&kviz)) << "; " << lice.ime<<", "<<lice.prezime<<", "<<lice.indeks;
